...
[assembly: ExportRenderer(typeof(AlphaSlider), typeof(AlphaSliderRenderer_Android))]

namespace TextBoxGenerationTool.Droid.CustomRenderers
{
    public class AlphaSliderRenderer_Android : SliderRenderer
    {
        public AlphaSliderRenderer_Android(Context context) : base(context)
        {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.Slider> e)
        {
            ...
            if (Control != null)
            {
                ...
                Control.Background = new GradientDrawable(GradientDrawable.Orientation.LeftRight,
                    new int[] { Color.Transparent.ToAndroid(), Color.Black.ToAndroid() });
            }
        }
